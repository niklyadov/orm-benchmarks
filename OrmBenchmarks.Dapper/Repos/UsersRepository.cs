...
{
    private readonly DapperApplicationContext _context;
    ...
    public async Task<User> Add(User user)
    {
        ...
        await connection.ExecuteAsync("INSERT INTO Users (Name, Age, IsDeleted) VALUES (@Name, @Age, @IsDeleted);",
            user);
    ...
    public async Task<User> GetById(long id)
    {
        ...
        return await connection.QuerySingleAsync<User>(
            "SELECT * FROM Users u WHERE u.Id = @Id AND u.IsDeleted = false;", new { Id = id });
    }
    ...
    public async Task<User> Update(User user)
    {
        ...
        await connection.ExecuteAsync(
            "UPDATE Users set Name = @Name, Age = @Age, IsDeleted = @IsDeleted, DeletedDateTime = @DeletedDateTime" +
